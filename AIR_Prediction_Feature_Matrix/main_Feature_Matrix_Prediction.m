...
for k = 1:1:length(TS)
    ...
    tbl_Features = table(subject, activity, cut_off_time, FIM_AD, BBS_AD, MWT10_SSV_AD, MWT10_FV_AD, MWT6_AD, TUG_AD, FIM_DC, BBS_DC, MWT10_SSV_DC, MWT10_FV_DC, MWT6_DC, TUG_DC, ...
