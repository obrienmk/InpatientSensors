...
for k = 1:1:length(TS)
    ...
    for n = 1:1:NoS_AD
        ...
        if ismember(n,ID_AD) == 0
            ...
            AD.AoM_Pel_tilt(n,:) = nan;
            AD.AoM_Pel_ro(n,:) = nan;
            AD.AoM_Pel_oblq(n,:) = nan;
            AD.AoM_Pel_norm(n,:) = nan;

            AD.AoM_Ankle_AS_x(n,:) = nan;
            AD.AoM_Ankle_US_x(n,:) = nan;
            AD.AoM_Ankle_AS_y(n,:) = nan;
            AD.AoM_Ankle_US_y(n,:) = nan;
            AD.AoM_Ankle_AS_z(n,:) = nan;
            AD.AoM_Ankle_US_z(n,:) = nan;
            AD.AoM_Ankle_AS_norm(n,:) = nan;
            AD.AoM_Ankle_US_norm(n,:) = nan;


            % General Features
            % Gyro mean
            AD.SC_Gyr_x_mean(n,:) = nan;
            AD.SC_Gyr_y_mean(n,:) = nan;
            AD.SC_Gyr_z_mean(n,:) = nan;
            AD.SC_Gyr_norm_mean(n,:) = nan;
            AD.DLS_R_Gyr_x_mean(n,:) = nan;
            AD.DLS_R_Gyr_y_mean(n,:) = nan;
            AD.DLS_R_Gyr_z_mean(n,:) = nan;
            AD.DLS_R_Gyr_norm_mean(n,:) = nan;
            AD.DLS_L_Gyr_x_mean(n,:) = nan;
            AD.DLS_L_Gyr_y_mean(n,:) = nan;
            AD.DLS_L_Gyr_z_mean(n,:) = nan;
            AD.DLS_L_Gyr_norm_mean(n,:) = nan;

            % Range
            AD.SC_Gyr_x_range(n,:) = nan;
            AD.SC_Gyr_y_range(n,:) = nan;
            AD.SC_Gyr_z_range(n,:) = nan;
            AD.SC_Gyr_norm_range(n,:) = nan;
            AD.DLS_R_Gyr_x_range(n,:) = nan;
            AD.DLS_R_Gyr_y_range(n,:) = nan;
            AD.DLS_R_Gyr_z_range(n,:) = nan;
            AD.DLS_R_Gyr_norm_range(n,:) = nan;
            AD.DLS_L_Gyr_x_range(n,:) = nan;
            AD.DLS_L_Gyr_y_range(n,:) = nan;
            AD.DLS_L_Gyr_z_range(n,:) = nan;
            AD.DLS_L_Gyr_norm_range(n,:) = nan;

            % RMS
            AD.SC_Gyr_x_rms(n,:) = nan;
            AD.SC_Gyr_y_rms(n,:) = nan;
            AD.SC_Gyr_z_rms(n,:) = nan;
            AD.SC_Gyr_norm_rms(n,:) = nan;
            AD.DLS_R_Gyr_x_rms(n,:) = nan;
            AD.DLS_R_Gyr_y_rms(n,:) = nan;
            AD.DLS_R_Gyr_z_rms(n,:) = nan;
            AD.DLS_R_Gyr_norm_rms(n,:) = nan;
            AD.DLS_L_Gyr_x_rms(n,:) = nan;
            AD.DLS_L_Gyr_y_rms(n,:) = nan;
            AD.DLS_L_Gyr_z_rms(n,:) = nan;
            AD.DLS_L_Gyr_norm_rms(n,:) = nan;

            % Standard Deviation
            AD.SC_Gyr_x_std(n,:) = nan;
            AD.SC_Gyr_y_std(n,:) = nan;
            AD.SC_Gyr_z_std(n,:) = nan;
            AD.SC_Gyr_norm_std(n,:) = nan;
            AD.DLS_R_Gyr_x_std(n,:) = nan;
            AD.DLS_R_Gyr_y_std(n,:) = nan;
            AD.DLS_R_Gyr_z_std(n,:) = nan;
            AD.DLS_R_Gyr_norm_std(n,:) = nan;
            AD.DLS_L_Gyr_x_std(n,:) = nan;
            AD.DLS_L_Gyr_y_std(n,:) = nan;
            AD.DLS_L_Gyr_z_std(n,:) = nan;
            AD.DLS_L_Gyr_norm_std(n,:) = nan;

            % Skew
            AD.SC_Gyr_x_skew(n,:) = nan;
            AD.SC_Gyr_y_skew(n,:) = nan;
            AD.SC_Gyr_z_skew(n,:) = nan;
            AD.SC_Gyr_norm_skew(n,:) = nan;
            AD.DLS_R_Gyr_x_skew(n,:) = nan;
            AD.DLS_R_Gyr_y_skew(n,:) = nan;
            AD.DLS_R_Gyr_z_skew(n,:) = nan;
            AD.DLS_R_Gyr_norm_skew(n,:) = nan;
            AD.DLS_L_Gyr_x_skew(n,:) = nan;
            AD.DLS_L_Gyr_y_skew(n,:) = nan;
            AD.DLS_L_Gyr_z_skew(n,:) = nan;
            AD.DLS_L_Gyr_norm_skew(n,:) = nan;

            % Kurtosis
            AD.SC_Gyr_x_kurtosis(n,:) = nan;
            AD.SC_Gyr_y_kurtosis(n,:) = nan;
            AD.SC_Gyr_z_kurtosis(n,:) = nan;
            AD.SC_Gyr_norm_kurtosis(n,:) = nan;
            AD.DLS_R_Gyr_x_kurtosis(n,:) = nan;
            AD.DLS_R_Gyr_y_kurtosis(n,:) = nan;
            AD.DLS_R_Gyr_z_kurtosis(n,:) = nan;
            AD.DLS_R_Gyr_norm_kurtosis(n,:) = nan;
            AD.DLS_L_Gyr_x_kurtosis(n,:) = nan;
            AD.DLS_L_Gyr_y_kurtosis(n,:) = nan;
            AD.DLS_L_Gyr_z_kurtosis(n,:) = nan;
            AD.DLS_L_Gyr_norm_kurtosis(n,:) = nan;

            % Pearson correlation coefficient
            AD.SC_Gyr_corr_xy(n,:) = nan;
            AD.SC_Gyr_corr_xz(n,:) = nan;
            AD.SC_Gyr_corr_yz(n,:) = nan;
            AD.DLS_R_Gyr_corr_xy(n,:) = nan;
            AD.DLS_R_Gyr_corr_xz(n,:) = nan;
            AD.DLS_R_Gyr_corr_yz(n,:) = nan;
            AD.DLS_L_Gyr_corr_xy(n,:) = nan;
            AD.DLS_L_Gyr_corr_xz(n,:) = nan;
            AD.DLS_L_Gyr_corr_yz(n,:) = nan;

            % Sample Entropy
            r = 0.2;
            AD.SC_Gyr_x_SamEn(n,:) = nan;
            AD.SC_Gyr_y_SamEn(n,:) = nan;
            AD.SC_Gyr_z_SamEn(n,:) = nan;
            AD.SC_Gyr_norm_SamEn(n,:) = nan;
            AD.DLS_R_Gyr_x_SamEn(n,:) = nan;
            AD.DLS_R_Gyr_y_SamEn(n,:) = nan;
            AD.DLS_R_Gyr_z_SamEn(n,:) = nan;
            AD.DLS_R_Gyr_norm_SamEn(n,:) = nan;
            AD.DLS_L_Gyr_x_SamEn(n,:) = nan;
            AD.DLS_L_Gyr_y_SamEn(n,:) = nan;
            AD.DLS_L_Gyr_z_SamEn(n,:) = nan;
            AD.DLS_L_Gyr_norm_SamEn(n,:) = nan;

            % Frequency Domain
            AD.SC_Gyr_x_DAmp(n,:) = nan;
            AD.SC_Gyr_x_DFreq(n,:) = nan;
            AD.SC_Gyr_x_PSD_mean(n,:) = nan;
            AD.SC_Gyr_x_PSD_std(n,:) = nan;
            AD.SC_Gyr_x_PSD_skew(n,:) = nan;
            AD.SC_Gyr_x_PSD_kurtosis(n,:) = nan;

            AD.SC_Gyr_y_DAmp(n,:) = nan;
            AD.SC_Gyr_y_DFreq(n,:) = nan;
            AD.SC_Gyr_y_PSD_mean(n,:) = nan;
            AD.SC_Gyr_y_PSD_std(n,:) = nan;
            AD.SC_Gyr_y_PSD_skew(n,:) = nan;
            AD.SC_Gyr_y_PSD_kurtosis(n,:) = nan;

            AD.SC_Gyr_z_DAmp(n,:) = nan;
            AD.SC_Gyr_z_DFreq(n,:) = nan;
            AD.SC_Gyr_z_PSD_mean(n,:) = nan;
            AD.SC_Gyr_z_PSD_std(n,:) = nan;
            AD.SC_Gyr_z_PSD_skew(n,:) = nan;
            AD.SC_Gyr_z_PSD_kurtosis(n,:) =nan;

            AD.SC_Gyr_norm_DAmp(n,:) = nan;
            AD.SC_Gyr_norm_DFreq(n,:) = nan;
            AD.SC_Gyr_norm_PSD_mean(n,:) = nan;
            AD.SC_Gyr_norm_PSD_std(n,:) = nan;
            AD.SC_Gyr_norm_PSD_skew(n,:) = nan;
            AD.SC_Gyr_norm_PSD_kurtosis(n,:) = nan;

            AD.DLS_R_Gyr_x_DAmp(n,:) = nan;
            AD.DLS_R_Gyr_x_DFreq(n,:) = nan;
            AD.DLS_R_Gyr_x_PSD_mean(n,:) = nan;
            AD.DLS_R_Gyr_x_PSD_std(n,:) = nan;
            AD.DLS_R_Gyr_x_PSD_skew(n,:) = nan;
            AD.DLS_R_Gyr_x_PSD_kurtosis(n,:) = nan;

            AD.DLS_R_Gyr_y_DAmp(n,:) = nan;
            AD.DLS_R_Gyr_y_DFreq(n,:) = nan;
            AD.DLS_R_Gyr_y_PSD_mean(n,:) = nan;
            AD.DLS_R_Gyr_y_PSD_std(n,:) = nan;
            AD.DLS_R_Gyr_y_PSD_skew(n,:) = nan;
            AD.DLS_R_Gyr_y_PSD_kurtosis(n,:) = nan;

            AD.DLS_R_Gyr_z_DAmp(n,:) = nan;
            AD.DLS_R_Gyr_z_DFreq(n,:) = nan;
            AD.DLS_R_Gyr_z_PSD_mean(n,:) = nan;
            AD.DLS_R_Gyr_z_PSD_std(n,:) = nan;
            AD.DLS_R_Gyr_z_PSD_skew(n,:) = nan;
            AD.DLS_R_Gyr_z_PSD_kurtosis(n,:) = nan;

            AD.DLS_R_Gyr_norm_DAmp(n,:) = nan;
            AD.DLS_R_Gyr_norm_DFreq(n,:) = nan;
            AD.DLS_R_Gyr_norm_PSD_mean(n,:) = nan;
            AD.DLS_R_Gyr_norm_PSD_std(n,:) = nan;
            AD.DLS_R_Gyr_norm_PSD_skew(n,:) = nan;
            AD.DLS_R_Gyr_norm_PSD_kurtosis(n,:) = nan;

            AD.DLS_L_Gyr_x_DAmp(n,:) = nan;
            AD.DLS_L_Gyr_x_DFreq(n,:) = nan;
            AD.DLS_L_Gyr_x_PSD_mean(n,:) = nan;
            AD.DLS_L_Gyr_x_PSD_std(n,:) = nan;
            AD.DLS_L_Gyr_x_PSD_skew(n,:) = nan;
            AD.DLS_L_Gyr_x_PSD_kurtosis(n,:) = nan;

            AD.DLS_L_Gyr_y_DAmp(n,:) = nan;
            AD.DLS_L_Gyr_y_DFreq(n,:) = nan;
            AD.DLS_L_Gyr_y_PSD_mean(n,:) = nan;
            AD.DLS_L_Gyr_y_PSD_std(n,:) = nan;
            AD.DLS_L_Gyr_y_PSD_skew(n,:) = nan;
            AD.DLS_L_Gyr_y_PSD_kurtosis(n,:) = nan;

            AD.DLS_L_Gyr_z_DAmp(n,:) = nan;
            AD.DLS_L_Gyr_z_DFreq(n,:) = nan;
            AD.DLS_L_Gyr_z_PSD_mean(n,:) = nan;
            AD.DLS_L_Gyr_z_PSD_std(n,:) = nan;
            AD.DLS_L_Gyr_z_PSD_skew(n,:) = nan;
            AD.DLS_L_Gyr_z_PSD_kurtosis(n,:) = nan;

            AD.DLS_L_Gyr_norm_DAmp(n,:) = nan;
            AD.DLS_L_Gyr_norm_DFreq(n,:) = nan;
            AD.DLS_L_Gyr_norm_PSD_mean(n,:) = nan;
            AD.DLS_L_Gyr_norm_PSD_std(n,:) = nan;
            AD.DLS_L_Gyr_norm_PSD_skew(n,:) = nan;
            AD.DLS_L_Gyr_norm_PSD_kurtosis(n,:) = nan;


            % Acc mean
            AD.SC_Acc_x_mean(n,:) = nan;
            AD.SC_Acc_y_mean(n,:) = nan;
            AD.SC_Acc_z_mean(n,:) = nan;
            AD.SC_Acc_norm_mean(n,:) = nan;
            AD.DLS_R_Acc_x_mean(n,:) = nan;
            AD.DLS_R_Acc_y_mean(n,:) = nan;
            AD.DLS_R_Acc_z_mean(n,:) = nan;
            AD.DLS_R_Acc_norm_mean(n,:) = nan;
            AD.DLS_L_Acc_x_mean(n,:) = nan;
            AD.DLS_L_Acc_y_mean(n,:) = nan;
            AD.DLS_L_Acc_z_mean(n,:) = nan;
            AD.DLS_L_Acc_norm_mean(n,:) = nan;

            % Range
            AD.SC_Acc_x_range(n,:) = nan;
            AD.SC_Acc_y_range(n,:) = nan;
            AD.SC_Acc_z_range(n,:) = nan;
            AD.SC_Acc_norm_range(n,:) = nan;
            AD.DLS_R_Acc_x_range(n,:) = nan;
            AD.DLS_R_Acc_y_range(n,:) = nan;
            AD.DLS_R_Acc_z_range(n,:) = nan;
            AD.DLS_R_Acc_norm_range(n,:) = nan;
            AD.DLS_L_Acc_x_range(n,:) = nan;
            AD.DLS_L_Acc_y_range(n,:) = nan;
            AD.DLS_L_Acc_z_range(n,:) = nan;
            AD.DLS_L_Acc_norm_range(n,:) = nan;

            % RMS
            AD.SC_Acc_x_rms(n,:) = nan;
            AD.SC_Acc_y_rms(n,:) = nan;
            AD.SC_Acc_z_rms(n,:) = nan;
            AD.SC_Acc_norm_rms(n,:) = nan;
            AD.DLS_R_Acc_x_rms(n,:) = nan;
            AD.DLS_R_Acc_y_rms(n,:) = nan;
            AD.DLS_R_Acc_z_rms(n,:) = nan;
            AD.DLS_R_Acc_norm_rms(n,:) = nan;
            AD.DLS_L_Acc_x_rms(n,:) = nan;
            AD.DLS_L_Acc_y_rms(n,:) = nan;
            AD.DLS_L_Acc_z_rms(n,:) = nan;
            AD.DLS_L_Acc_norm_rms(n,:) = nan;

            % Standard Deviation
            AD.SC_Acc_x_std(n,:) = nan;
            AD.SC_Acc_y_std(n,:) = nan;
            AD.SC_Acc_z_std(n,:) = nan;
            AD.SC_Acc_norm_std(n,:) = nan;
            AD.DLS_R_Acc_x_std(n,:) = nan;
            AD.DLS_R_Acc_y_std(n,:) = nan;
            AD.DLS_R_Acc_z_std(n,:) = nan;
            AD.DLS_R_Acc_norm_std(n,:) = nan;
            AD.DLS_L_Acc_x_std(n,:) = nan;
            AD.DLS_L_Acc_y_std(n,:) = nan;
            AD.DLS_L_Acc_z_std(n,:) = nan;
            AD.DLS_L_Acc_norm_std(n,:) = nan;

            % Skew
            AD.SC_Acc_x_skew(n,:) = nan;
            AD.SC_Acc_y_skew(n,:) = nan;
            AD.SC_Acc_z_skew(n,:) = nan;
            AD.SC_Acc_norm_skew(n,:) = nan;
            AD.DLS_R_Acc_x_skew(n,:) = nan;
            AD.DLS_R_Acc_y_skew(n,:) = nan;
            AD.DLS_R_Acc_z_skew(n,:) = nan;
            AD.DLS_R_Acc_norm_skew(n,:) = nan;
            AD.DLS_L_Acc_x_skew(n,:) = nan;
            AD.DLS_L_Acc_y_skew(n,:) = nan;
            AD.DLS_L_Acc_z_skew(n,:) = nan;
            AD.DLS_L_Acc_norm_skew(n,:) = nan;

            % Kurtosis
            AD.SC_Acc_x_kurtosis(n,:) = nan;
            AD.SC_Acc_y_kurtosis(n,:) = nan;
            AD.SC_Acc_z_kurtosis(n,:) = nan;
            AD.SC_Acc_norm_kurtosis(n,:) = nan;
            AD.DLS_R_Acc_x_kurtosis(n,:) = nan;
            AD.DLS_R_Acc_y_kurtosis(n,:) = nan;
            AD.DLS_R_Acc_z_kurtosis(n,:) = nan;
            AD.DLS_R_Acc_norm_kurtosis(n,:) = nan;
            AD.DLS_L_Acc_x_kurtosis(n,:) = nan;
            AD.DLS_L_Acc_y_kurtosis(n,:) = nan;
            AD.DLS_L_Acc_z_kurtosis(n,:) = nan;
            AD.DLS_L_Acc_norm_kurtosis(n,:) = nan;

            % Pearson correlation coefficient
            AD.SC_Acc_corr_xy(n,:) = nan;
            AD.SC_Acc_corr_xz(n,:) = nan;
            AD.SC_Acc_corr_yz(n,:) = nan;
            AD.DLS_R_Acc_corr_xy(n,:) = nan;
            AD.DLS_R_Acc_corr_xz(n,:) = nan;
            AD.DLS_R_Acc_corr_yz(n,:) = nan;
            AD.DLS_L_Acc_corr_xy(n,:) = nan;
            AD.DLS_L_Acc_corr_xz(n,:) = nan;
            AD.DLS_L_Acc_corr_yz(n,:) = nan;

            % Sample Entropy
            r = 0.2;
            AD.SC_Acc_x_SamEn(n,:) = nan;
            AD.SC_Acc_y_SamEn(n,:) = nan;
            AD.SC_Acc_z_SamEn(n,:) = nan;
            AD.SC_Acc_norm_SamEn(n,:) = nan;
            AD.DLS_R_Acc_x_SamEn(n,:) = nan;
            AD.DLS_R_Acc_y_SamEn(n,:) = nan;
            AD.DLS_R_Acc_z_SamEn(n,:) = nan;
            AD.DLS_R_Acc_norm_SamEn(n,:) = nan;
            AD.DLS_L_Acc_x_SamEn(n,:) = nan;
            AD.DLS_L_Acc_y_SamEn(n,:) = nan;
            AD.DLS_L_Acc_z_SamEn(n,:) = nan;
            AD.DLS_L_Acc_norm_SamEn(n,:) = nan;


            % Frequency Domain
            AD.SC_Acc_x_DAmp(n,:) = nan;
            AD.SC_Acc_x_DFreq(n,:) = nan;
            AD.SC_Acc_x_PSD_mean(n,:) = nan;
            AD.SC_Acc_x_PSD_std(n,:) = nan;
            AD.SC_Acc_x_PSD_skew(n,:) = nan;
            AD.SC_Acc_x_PSD_kurtosis(n,:) = nan;

            AD.SC_Acc_y_DAmp(n,:) = nan;
            AD.SC_Acc_y_DFreq(n,:) = nan;
            AD.SC_Acc_y_PSD_mean(n,:) = nan;
            AD.SC_Acc_y_PSD_std(n,:) = nan;
            AD.SC_Acc_y_PSD_skew(n,:) = nan;
            AD.SC_Acc_y_PSD_kurtosis(n,:) = nan;

            AD.SC_Acc_z_DAmp(n,:) = nan;
            AD.SC_Acc_z_DFreq(n,:) = nan;
            AD.SC_Acc_z_PSD_mean(n,:) = nan;
            AD.SC_Acc_z_PSD_std(n,:) = nan;
            AD.SC_Acc_z_PSD_skew(n,:) = nan;
            AD.SC_Acc_z_PSD_kurtosis(n,:) = nan;

            AD.SC_Acc_norm_DAmp(n,:) = nan;
            AD.SC_Acc_norm_DFreq(n,:) = nan;
            AD.SC_Acc_norm_PSD_mean(n,:) = nan;
            AD.SC_Acc_norm_PSD_std(n,:) = nan;
            AD.SC_Acc_norm_PSD_skew(n,:) = nan;
            AD.SC_Acc_norm_PSD_kurtosis(n,:) = nan;

            AD.DLS_R_Acc_x_DAmp(n,:) = nan;
            AD.DLS_R_Acc_x_DFreq(n,:) = nan;
            AD.DLS_R_Acc_x_PSD_mean(n,:) = nan;
            AD.DLS_R_Acc_x_PSD_std(n,:) = nan;
            AD.DLS_R_Acc_x_PSD_skew(n,:) = nan;
            AD.DLS_R_Acc_x_PSD_kurtosis(n,:) = nan;

            AD.DLS_R_Acc_y_DAmp(n,:) = nan;
            AD.DLS_R_Acc_y_DFreq(n,:) = nan;
            AD.DLS_R_Acc_y_PSD_mean(n,:) = nan;
            AD.DLS_R_Acc_y_PSD_std(n,:) = nan;
            AD.DLS_R_Acc_y_PSD_skew(n,:) = nan;
            AD.DLS_R_Acc_y_PSD_kurtosis(n,:) = nan;

            AD.DLS_R_Acc_z_DAmp(n,:) = nan;
            AD.DLS_R_Acc_z_DFreq(n,:) = nan;
            AD.DLS_R_Acc_z_PSD_mean(n,:) = nan;
            AD.DLS_R_Acc_z_PSD_std(n,:) = nan;
            AD.DLS_R_Acc_z_PSD_skew(n,:) = nan;
            AD.DLS_R_Acc_z_PSD_kurtosis(n,:) = nan;

            AD.DLS_R_Acc_norm_DAmp(n,:) = nan;
            AD.DLS_R_Acc_norm_DFreq(n,:) = nan;
            AD.DLS_R_Acc_norm_PSD_mean(n,:) = nan;
            AD.DLS_R_Acc_norm_PSD_std(n,:) = nan;
            AD.DLS_R_Acc_norm_PSD_skew(n,:) = nan;
            AD.DLS_R_Acc_norm_PSD_kurtosis(n,:) = nan;

            AD.DLS_L_Acc_x_DAmp(n,:) = nan;
            AD.DLS_L_Acc_x_DFreq(n,:) = nan;
            AD.DLS_L_Acc_x_PSD_mean(n,:) = nan;
            AD.DLS_L_Acc_x_PSD_std(n,:) = nan;
            AD.DLS_L_Acc_x_PSD_skew(n,:) = nan;
            AD.DLS_L_Acc_x_PSD_kurtosis(n,:) = nan;

            AD.DLS_L_Acc_y_DAmp(n,:) = nan;
            AD.DLS_L_Acc_y_DFreq(n,:) = nan;
            AD.DLS_L_Acc_y_PSD_mean(n,:) = nan;
            AD.DLS_L_Acc_y_PSD_std(n,:) = nan;
            AD.DLS_L_Acc_y_PSD_skew(n,:) = nan;
            AD.DLS_L_Acc_y_PSD_kurtosis(n,:) = nan;

            AD.DLS_L_Acc_z_DAmp(n,:) = nan;
            AD.DLS_L_Acc_z_DFreq(n,:) = nan;
            AD.DLS_L_Acc_z_PSD_mean(n,:) = nan;
            AD.DLS_L_Acc_z_PSD_std(n,:) = nan;
            AD.DLS_L_Acc_z_PSD_skew(n,:) = nan;
            AD.DLS_L_Acc_z_PSD_kurtosis(n,:) = nan;

            AD.DLS_L_Acc_norm_DAmp(n,:) = nan;
            AD.DLS_L_Acc_norm_DFreq(n,:) = nan;
            AD.DLS_L_Acc_norm_PSD_mean(n,:) = nan;
            AD.DLS_L_Acc_norm_PSD_std(n,:) = nan;
            AD.DLS_L_Acc_norm_PSD_skew(n,:) = nan;
            AD.DLS_L_Acc_norm_PSD_kurtosis(n,:) = nan;
            
        elseif ismember(n,ID_AD) == 1
        
            file_input = ['../Sensor_Data/' Type_of_Subject '_MWT6_ID' sprintf('%.2d',n) '.mat']
            load(file_input);
    ...
    for n = 1:1:NoS_DC
        ...
        if ismember(n,ID_DC) == 0
            ...
            % Amount of motion
            % Pelvic Amount of motion 
            DC.AoM_Pel_tilt(n,:) = nan;
            DC.AoM_Pel_ro(n,:) = nan;
            DC.AoM_Pel_oblq(n,:) = nan;
            DC.AoM_Pel_norm(n,:) = nan;

            DC.AoM_Ankle_AS_x(n,:) = nan;
            DC.AoM_Ankle_US_x(n,:) = nan;
            DC.AoM_Ankle_AS_y(n,:) = nan;
            DC.AoM_Ankle_US_y(n,:) = nan;
            DC.AoM_Ankle_AS_z(n,:) = nan;
            DC.AoM_Ankle_US_z(n,:) = nan;
            DC.AoM_Ankle_AS_norm(n,:) = nan;
            DC.AoM_Ankle_US_norm(n,:) = nan;

            % General Features
            % Gyro mean
            DC.SC_Gyr_x_mean(n,:) = nan;
            DC.SC_Gyr_y_mean(n,:) = nan;
            DC.SC_Gyr_z_mean(n,:) = nan;
            DC.SC_Gyr_norm_mean(n,:) = nan;
            DC.DLS_R_Gyr_x_mean(n,:) = nan;
            DC.DLS_R_Gyr_y_mean(n,:) = nan;
            DC.DLS_R_Gyr_z_mean(n,:) = nan;
            DC.DLS_R_Gyr_norm_mean(n,:) = nan;
            DC.DLS_L_Gyr_x_mean(n,:) = nan;
            DC.DLS_L_Gyr_y_mean(n,:) = nan;
            DC.DLS_L_Gyr_z_mean(n,:) = nan;
            DC.DLS_L_Gyr_norm_mean(n,:) = nan;

            % Range
            DC.SC_Gyr_x_range(n,:) = nan;
            DC.SC_Gyr_y_range(n,:) = nan;
            DC.SC_Gyr_z_range(n,:) = nan;
            DC.SC_Gyr_norm_range(n,:) = nan;
            DC.DLS_R_Gyr_x_range(n,:) = nan;
            DC.DLS_R_Gyr_y_range(n,:) = nan;
            DC.DLS_R_Gyr_z_range(n,:) = nan;
            DC.DLS_R_Gyr_norm_range(n,:) = nan;
            DC.DLS_L_Gyr_x_range(n,:) = nan;
            DC.DLS_L_Gyr_y_range(n,:) = nan;
            DC.DLS_L_Gyr_z_range(n,:) = nan;
            DC.DLS_L_Gyr_norm_range(n,:) = nan;

            % RMS
            DC.SC_Gyr_x_rms(n,:) = nan;
            DC.SC_Gyr_y_rms(n,:) = nan;
            DC.SC_Gyr_z_rms(n,:) = nan;
            DC.SC_Gyr_norm_rms(n,:) = nan;
            DC.DLS_R_Gyr_x_rms(n,:) = nan;
            DC.DLS_R_Gyr_y_rms(n,:) = nan;
            DC.DLS_R_Gyr_z_rms(n,:) = nan;
            DC.DLS_R_Gyr_norm_rms(n,:) = nan;
            DC.DLS_L_Gyr_x_rms(n,:) = nan;
            DC.DLS_L_Gyr_y_rms(n,:) = nan;
            DC.DLS_L_Gyr_z_rms(n,:) = nan;
            DC.DLS_L_Gyr_norm_rms(n,:) = nan;

            % Standard Deviation
            DC.SC_Gyr_x_std(n,:) = nan;
            DC.SC_Gyr_y_std(n,:) = nan;
            DC.SC_Gyr_z_std(n,:) = nan;
            DC.SC_Gyr_norm_std(n,:) = nan;
            DC.DLS_R_Gyr_x_std(n,:) = nan;
            DC.DLS_R_Gyr_y_std(n,:) = nan;
            DC.DLS_R_Gyr_z_std(n,:) = nan;
            DC.DLS_R_Gyr_norm_std(n,:) = nan;
            DC.DLS_L_Gyr_x_std(n,:) = nan;
            DC.DLS_L_Gyr_y_std(n,:) = nan;
            DC.DLS_L_Gyr_z_std(n,:) = nan;
            DC.DLS_L_Gyr_norm_std(n,:) = nan;

            % Skew
            DC.SC_Gyr_x_skew(n,:) = nan;
            DC.SC_Gyr_y_skew(n,:) = nan;
            DC.SC_Gyr_z_skew(n,:) = nan;
            DC.SC_Gyr_norm_skew(n,:) = nan;
            DC.DLS_R_Gyr_x_skew(n,:) = nan;
            DC.DLS_R_Gyr_y_skew(n,:) = nan;
            DC.DLS_R_Gyr_z_skew(n,:) = nan;
            DC.DLS_R_Gyr_norm_skew(n,:) = nan;
            DC.DLS_L_Gyr_x_skew(n,:) = nan;
            DC.DLS_L_Gyr_y_skew(n,:) = nan;
            DC.DLS_L_Gyr_z_skew(n,:) = nan;
            DC.DLS_L_Gyr_norm_skew(n,:) = nan;

            % Kurtosis
            DC.SC_Gyr_x_kurtosis(n,:) = nan;
            DC.SC_Gyr_y_kurtosis(n,:) = nan;
            DC.SC_Gyr_z_kurtosis(n,:) = nan;
            DC.SC_Gyr_norm_kurtosis(n,:) = nan;
            DC.DLS_R_Gyr_x_kurtosis(n,:) = nan;
            DC.DLS_R_Gyr_y_kurtosis(n,:) = nan;
            DC.DLS_R_Gyr_z_kurtosis(n,:) = nan;
            DC.DLS_R_Gyr_norm_kurtosis(n,:) = nan;
            DC.DLS_L_Gyr_x_kurtosis(n,:) = nan;
            DC.DLS_L_Gyr_y_kurtosis(n,:) = nan;
            DC.DLS_L_Gyr_z_kurtosis(n,:) = nan;
            DC.DLS_L_Gyr_norm_kurtosis(n,:) = nan;

            % Pearson correlation coefficient
            DC.SC_Gyr_corr_xy(n,:) = nan;
            DC.SC_Gyr_corr_xz(n,:) = nan;
            DC.SC_Gyr_corr_yz(n,:) = nan;
            DC.DLS_R_Gyr_corr_xy(n,:) = nan;
            DC.DLS_R_Gyr_corr_xz(n,:) = nan;
            DC.DLS_R_Gyr_corr_yz(n,:) = nan;
            DC.DLS_L_Gyr_corr_xy(n,:) = nan;
            DC.DLS_L_Gyr_corr_xz(n,:) = nan;
            DC.DLS_L_Gyr_corr_yz(n,:) = nan;

            % Sample Entropy
            r = 0.2;
            DC.SC_Gyr_x_SamEn(n,:) = nan;
            DC.SC_Gyr_y_SamEn(n,:) = nan;
            DC.SC_Gyr_z_SamEn(n,:) = nan;
            DC.SC_Gyr_norm_SamEn(n,:) = nan;
            DC.DLS_R_Gyr_x_SamEn(n,:) = nan;
            DC.DLS_R_Gyr_y_SamEn(n,:) = nan;
            DC.DLS_R_Gyr_z_SamEn(n,:) = nan;
            DC.DLS_R_Gyr_norm_SamEn(n,:) = nan;
            DC.DLS_L_Gyr_x_SamEn(n,:) = nan;
            DC.DLS_L_Gyr_y_SamEn(n,:) = nan;
            DC.DLS_L_Gyr_z_SamEn(n,:) = nan;
            DC.DLS_L_Gyr_norm_SamEn(n,:) = nan;

            % Frequency Domain
            DC.SC_Gyr_x_DAmp(n,:) = nan;
            DC.SC_Gyr_x_DFreq(n,:) = nan;
            DC.SC_Gyr_x_PSD_mean(n,:) = nan;
            DC.SC_Gyr_x_PSD_std(n,:) = nan;
            DC.SC_Gyr_x_PSD_skew(n,:) = nan;
            DC.SC_Gyr_x_PSD_kurtosis(n,:) = nan;

            DC.SC_Gyr_y_DAmp(n,:) = nan;
            DC.SC_Gyr_y_DFreq(n,:) = nan;
            DC.SC_Gyr_y_PSD_mean(n,:) = nan;
            DC.SC_Gyr_y_PSD_std(n,:) = nan;
            DC.SC_Gyr_y_PSD_skew(n,:) = nan;
            DC.SC_Gyr_y_PSD_kurtosis(n,:) = nan;

            DC.SC_Gyr_z_DAmp(n,:) = nan;
            DC.SC_Gyr_z_DFreq(n,:) = nan;
            DC.SC_Gyr_z_PSD_mean(n,:) = nan;
            DC.SC_Gyr_z_PSD_std(n,:) = nan;
            DC.SC_Gyr_z_PSD_skew(n,:) = nan;
            DC.SC_Gyr_z_PSD_kurtosis(n,:) =nan;

            DC.SC_Gyr_norm_DAmp(n,:) = nan;
            DC.SC_Gyr_norm_DFreq(n,:) = nan;
            DC.SC_Gyr_norm_PSD_mean(n,:) = nan;
            DC.SC_Gyr_norm_PSD_std(n,:) = nan;
            DC.SC_Gyr_norm_PSD_skew(n,:) = nan;
            DC.SC_Gyr_norm_PSD_kurtosis(n,:) = nan;

            DC.DLS_R_Gyr_x_DAmp(n,:) = nan;
            DC.DLS_R_Gyr_x_DFreq(n,:) = nan;
            DC.DLS_R_Gyr_x_PSD_mean(n,:) = nan;
            DC.DLS_R_Gyr_x_PSD_std(n,:) = nan;
            DC.DLS_R_Gyr_x_PSD_skew(n,:) = nan;
            DC.DLS_R_Gyr_x_PSD_kurtosis(n,:) = nan;

            DC.DLS_R_Gyr_y_DAmp(n,:) = nan;
            DC.DLS_R_Gyr_y_DFreq(n,:) = nan;
            DC.DLS_R_Gyr_y_PSD_mean(n,:) = nan;
            DC.DLS_R_Gyr_y_PSD_std(n,:) = nan;
            DC.DLS_R_Gyr_y_PSD_skew(n,:) = nan;
            DC.DLS_R_Gyr_y_PSD_kurtosis(n,:) = nan;

            DC.DLS_R_Gyr_z_DAmp(n,:) = nan;
            DC.DLS_R_Gyr_z_DFreq(n,:) = nan;
            DC.DLS_R_Gyr_z_PSD_mean(n,:) = nan;
            DC.DLS_R_Gyr_z_PSD_std(n,:) = nan;
            DC.DLS_R_Gyr_z_PSD_skew(n,:) = nan;
            DC.DLS_R_Gyr_z_PSD_kurtosis(n,:) = nan;

            DC.DLS_R_Gyr_norm_DAmp(n,:) = nan;
            DC.DLS_R_Gyr_norm_DFreq(n,:) = nan;
            DC.DLS_R_Gyr_norm_PSD_mean(n,:) = nan;
            DC.DLS_R_Gyr_norm_PSD_std(n,:) = nan;
            DC.DLS_R_Gyr_norm_PSD_skew(n,:) = nan;
            DC.DLS_R_Gyr_norm_PSD_kurtosis(n,:) = nan;

            DC.DLS_L_Gyr_x_DAmp(n,:) = nan;
            DC.DLS_L_Gyr_x_DFreq(n,:) = nan;
            DC.DLS_L_Gyr_x_PSD_mean(n,:) = nan;
            DC.DLS_L_Gyr_x_PSD_std(n,:) = nan;
            DC.DLS_L_Gyr_x_PSD_skew(n,:) = nan;
            DC.DLS_L_Gyr_x_PSD_kurtosis(n,:) = nan;

            DC.DLS_L_Gyr_y_DAmp(n,:) = nan;
            DC.DLS_L_Gyr_y_DFreq(n,:) = nan;
            DC.DLS_L_Gyr_y_PSD_mean(n,:) = nan;
            DC.DLS_L_Gyr_y_PSD_std(n,:) = nan;
            DC.DLS_L_Gyr_y_PSD_skew(n,:) = nan;
            DC.DLS_L_Gyr_y_PSD_kurtosis(n,:) = nan;

            DC.DLS_L_Gyr_z_DAmp(n,:) = nan;
            DC.DLS_L_Gyr_z_DFreq(n,:) = nan;
            DC.DLS_L_Gyr_z_PSD_mean(n,:) = nan;
            DC.DLS_L_Gyr_z_PSD_std(n,:) = nan;
            DC.DLS_L_Gyr_z_PSD_skew(n,:) = nan;
            DC.DLS_L_Gyr_z_PSD_kurtosis(n,:) = nan;

            DC.DLS_L_Gyr_norm_DAmp(n,:) = nan;
            DC.DLS_L_Gyr_norm_DFreq(n,:) = nan;
            DC.DLS_L_Gyr_norm_PSD_mean(n,:) = nan;
            DC.DLS_L_Gyr_norm_PSD_std(n,:) = nan;
            DC.DLS_L_Gyr_norm_PSD_skew(n,:) = nan;
            DC.DLS_L_Gyr_norm_PSD_kurtosis(n,:) = nan;


            % Acc mean
            DC.SC_Acc_x_mean(n,:) = nan;
            DC.SC_Acc_y_mean(n,:) = nan;
            DC.SC_Acc_z_mean(n,:) = nan;
            DC.SC_Acc_norm_mean(n,:) = nan;
            DC.DLS_R_Acc_x_mean(n,:) = nan;
            DC.DLS_R_Acc_y_mean(n,:) = nan;
            DC.DLS_R_Acc_z_mean(n,:) = nan;
            DC.DLS_R_Acc_norm_mean(n,:) = nan;
            DC.DLS_L_Acc_x_mean(n,:) = nan;
            DC.DLS_L_Acc_y_mean(n,:) = nan;
            DC.DLS_L_Acc_z_mean(n,:) = nan;
            DC.DLS_L_Acc_norm_mean(n,:) = nan;

            % Range
            DC.SC_Acc_x_range(n,:) = nan;
            DC.SC_Acc_y_range(n,:) = nan;
            DC.SC_Acc_z_range(n,:) = nan;
            DC.SC_Acc_norm_range(n,:) = nan;
            DC.DLS_R_Acc_x_range(n,:) = nan;
            DC.DLS_R_Acc_y_range(n,:) = nan;
            DC.DLS_R_Acc_z_range(n,:) = nan;
            DC.DLS_R_Acc_norm_range(n,:) = nan;
            DC.DLS_L_Acc_x_range(n,:) = nan;
            DC.DLS_L_Acc_y_range(n,:) = nan;
            DC.DLS_L_Acc_z_range(n,:) = nan;
            DC.DLS_L_Acc_norm_range(n,:) = nan;

            % RMS
            DC.SC_Acc_x_rms(n,:) = nan;
            DC.SC_Acc_y_rms(n,:) = nan;
            DC.SC_Acc_z_rms(n,:) = nan;
            DC.SC_Acc_norm_rms(n,:) = nan;
            DC.DLS_R_Acc_x_rms(n,:) = nan;
            DC.DLS_R_Acc_y_rms(n,:) = nan;
            DC.DLS_R_Acc_z_rms(n,:) = nan;
            DC.DLS_R_Acc_norm_rms(n,:) = nan;
            DC.DLS_L_Acc_x_rms(n,:) = nan;
            DC.DLS_L_Acc_y_rms(n,:) = nan;
            DC.DLS_L_Acc_z_rms(n,:) = nan;
            DC.DLS_L_Acc_norm_rms(n,:) = nan;

            % Standard Deviation
            DC.SC_Acc_x_std(n,:) = nan;
            DC.SC_Acc_y_std(n,:) = nan;
            DC.SC_Acc_z_std(n,:) = nan;
            DC.SC_Acc_norm_std(n,:) = nan;
            DC.DLS_R_Acc_x_std(n,:) = nan;
            DC.DLS_R_Acc_y_std(n,:) = nan;
            DC.DLS_R_Acc_z_std(n,:) = nan;
            DC.DLS_R_Acc_norm_std(n,:) = nan;
            DC.DLS_L_Acc_x_std(n,:) = nan;
            DC.DLS_L_Acc_y_std(n,:) = nan;
            DC.DLS_L_Acc_z_std(n,:) = nan;
            DC.DLS_L_Acc_norm_std(n,:) = nan;

            % Skew
            DC.SC_Acc_x_skew(n,:) = nan;
            DC.SC_Acc_y_skew(n,:) = nan;
            DC.SC_Acc_z_skew(n,:) = nan;
            DC.SC_Acc_norm_skew(n,:) = nan;
            DC.DLS_R_Acc_x_skew(n,:) = nan;
            DC.DLS_R_Acc_y_skew(n,:) = nan;
            DC.DLS_R_Acc_z_skew(n,:) = nan;
            DC.DLS_R_Acc_norm_skew(n,:) = nan;
            DC.DLS_L_Acc_x_skew(n,:) = nan;
            DC.DLS_L_Acc_y_skew(n,:) = nan;
            DC.DLS_L_Acc_z_skew(n,:) = nan;
            DC.DLS_L_Acc_norm_skew(n,:) = nan;

            % Kurtosis
            DC.SC_Acc_x_kurtosis(n,:) = nan;
            DC.SC_Acc_y_kurtosis(n,:) = nan;
            DC.SC_Acc_z_kurtosis(n,:) = nan;
            DC.SC_Acc_norm_kurtosis(n,:) = nan;
            DC.DLS_R_Acc_x_kurtosis(n,:) = nan;
            DC.DLS_R_Acc_y_kurtosis(n,:) = nan;
            DC.DLS_R_Acc_z_kurtosis(n,:) = nan;
            DC.DLS_R_Acc_norm_kurtosis(n,:) = nan;
            DC.DLS_L_Acc_x_kurtosis(n,:) = nan;
            DC.DLS_L_Acc_y_kurtosis(n,:) = nan;
            DC.DLS_L_Acc_z_kurtosis(n,:) = nan;
            DC.DLS_L_Acc_norm_kurtosis(n,:) = nan;

            % Pearson correlation coefficient
            DC.SC_Acc_corr_xy(n,:) = nan;
            DC.SC_Acc_corr_xz(n,:) = nan;
            DC.SC_Acc_corr_yz(n,:) = nan;
            DC.DLS_R_Acc_corr_xy(n,:) = nan;
            DC.DLS_R_Acc_corr_xz(n,:) = nan;
            DC.DLS_R_Acc_corr_yz(n,:) = nan;
            DC.DLS_L_Acc_corr_xy(n,:) = nan;
            DC.DLS_L_Acc_corr_xz(n,:) = nan;
            DC.DLS_L_Acc_corr_yz(n,:) = nan;

            % Sample Entropy
            r = 0.2;
            DC.SC_Acc_x_SamEn(n,:) = nan;
            DC.SC_Acc_y_SamEn(n,:) = nan;
            DC.SC_Acc_z_SamEn(n,:) = nan;
            DC.SC_Acc_norm_SamEn(n,:) = nan;
            DC.DLS_R_Acc_x_SamEn(n,:) = nan;
            DC.DLS_R_Acc_y_SamEn(n,:) = nan;
            DC.DLS_R_Acc_z_SamEn(n,:) = nan;
            DC.DLS_R_Acc_norm_SamEn(n,:) = nan;
            DC.DLS_L_Acc_x_SamEn(n,:) = nan;
            DC.DLS_L_Acc_y_SamEn(n,:) = nan;
            DC.DLS_L_Acc_z_SamEn(n,:) = nan;
            DC.DLS_L_Acc_norm_SamEn(n,:) = nan;


            % Frequency Domain
            DC.SC_Acc_x_DAmp(n,:) = nan;
            DC.SC_Acc_x_DFreq(n,:) = nan;
            DC.SC_Acc_x_PSD_mean(n,:) = nan;
            DC.SC_Acc_x_PSD_std(n,:) = nan;
            DC.SC_Acc_x_PSD_skew(n,:) = nan;
            DC.SC_Acc_x_PSD_kurtosis(n,:) = nan;

            DC.SC_Acc_y_DAmp(n,:) = nan;
            DC.SC_Acc_y_DFreq(n,:) = nan;
            DC.SC_Acc_y_PSD_mean(n,:) = nan;
            DC.SC_Acc_y_PSD_std(n,:) = nan;
            DC.SC_Acc_y_PSD_skew(n,:) = nan;
            DC.SC_Acc_y_PSD_kurtosis(n,:) = nan;

            DC.SC_Acc_z_DAmp(n,:) = nan;
            DC.SC_Acc_z_DFreq(n,:) = nan;
            DC.SC_Acc_z_PSD_mean(n,:) = nan;
            DC.SC_Acc_z_PSD_std(n,:) = nan;
            DC.SC_Acc_z_PSD_skew(n,:) = nan;
            DC.SC_Acc_z_PSD_kurtosis(n,:) = nan;

            DC.SC_Acc_norm_DAmp(n,:) = nan;
            DC.SC_Acc_norm_DFreq(n,:) = nan;
            DC.SC_Acc_norm_PSD_mean(n,:) = nan;
            DC.SC_Acc_norm_PSD_std(n,:) = nan;
            DC.SC_Acc_norm_PSD_skew(n,:) = nan;
            DC.SC_Acc_norm_PSD_kurtosis(n,:) = nan;

            DC.DLS_R_Acc_x_DAmp(n,:) = nan;
            DC.DLS_R_Acc_x_DFreq(n,:) = nan;
            DC.DLS_R_Acc_x_PSD_mean(n,:) = nan;
            DC.DLS_R_Acc_x_PSD_std(n,:) = nan;
            DC.DLS_R_Acc_x_PSD_skew(n,:) = nan;
            DC.DLS_R_Acc_x_PSD_kurtosis(n,:) = nan;

            DC.DLS_R_Acc_y_DAmp(n,:) = nan;
            DC.DLS_R_Acc_y_DFreq(n,:) = nan;
            DC.DLS_R_Acc_y_PSD_mean(n,:) = nan;
            DC.DLS_R_Acc_y_PSD_std(n,:) = nan;
            DC.DLS_R_Acc_y_PSD_skew(n,:) = nan;
            DC.DLS_R_Acc_y_PSD_kurtosis(n,:) = nan;

            DC.DLS_R_Acc_z_DAmp(n,:) = nan;
            DC.DLS_R_Acc_z_DFreq(n,:) = nan;
            DC.DLS_R_Acc_z_PSD_mean(n,:) = nan;
            DC.DLS_R_Acc_z_PSD_std(n,:) = nan;
            DC.DLS_R_Acc_z_PSD_skew(n,:) = nan;
            DC.DLS_R_Acc_z_PSD_kurtosis(n,:) = nan;

            DC.DLS_R_Acc_norm_DAmp(n,:) = nan;
            DC.DLS_R_Acc_norm_DFreq(n,:) = nan;
            DC.DLS_R_Acc_norm_PSD_mean(n,:) = nan;
            DC.DLS_R_Acc_norm_PSD_std(n,:) = nan;
            DC.DLS_R_Acc_norm_PSD_skew(n,:) = nan;
            DC.DLS_R_Acc_norm_PSD_kurtosis(n,:) = nan;

            DC.DLS_L_Acc_x_DAmp(n,:) = nan;
            DC.DLS_L_Acc_x_DFreq(n,:) = nan;
            DC.DLS_L_Acc_x_PSD_mean(n,:) = nan;
            DC.DLS_L_Acc_x_PSD_std(n,:) = nan;
            DC.DLS_L_Acc_x_PSD_skew(n,:) = nan;
            DC.DLS_L_Acc_x_PSD_kurtosis(n,:) = nan;

            DC.DLS_L_Acc_y_DAmp(n,:) = nan;
            DC.DLS_L_Acc_y_DFreq(n,:) = nan;
            DC.DLS_L_Acc_y_PSD_mean(n,:) = nan;
            DC.DLS_L_Acc_y_PSD_std(n,:) = nan;
            DC.DLS_L_Acc_y_PSD_skew(n,:) = nan;
            DC.DLS_L_Acc_y_PSD_kurtosis(n,:) = nan;

            DC.DLS_L_Acc_z_DAmp(n,:) = nan;
            DC.DLS_L_Acc_z_DFreq(n,:) = nan;
            DC.DLS_L_Acc_z_PSD_mean(n,:) = nan;
            DC.DLS_L_Acc_z_PSD_std(n,:) = nan;
            DC.DLS_L_Acc_z_PSD_skew(n,:) = nan;
            DC.DLS_L_Acc_z_PSD_kurtosis(n,:) = nan;

            DC.DLS_L_Acc_norm_DAmp(n,:) = nan;
            DC.DLS_L_Acc_norm_DFreq(n,:) = nan;
            DC.DLS_L_Acc_norm_PSD_mean(n,:) = nan;
            DC.DLS_L_Acc_norm_PSD_std(n,:) = nan;
            DC.DLS_L_Acc_norm_PSD_skew(n,:) = nan;
            DC.DLS_L_Acc_norm_PSD_kurtosis(n,:) = nan;
            
        elseif ismember(n,ID_DC) == 1
    ...
    for n = 1:1:NoS_HC
        ...
        if ismember(n,ID_HC) == 0
            ...
            % Amount of motion
            % Pelvic Amount of motion 
            HC.AoM_Pel_tilt(n,:) = nan;
            HC.AoM_Pel_ro(n,:) = nan;
            HC.AoM_Pel_oblq(n,:) = nan;
            HC.AoM_Pel_norm(n,:) = nan;

            HC.AoM_Ankle_L_x(n,:) = nan;
            HC.AoM_Ankle_R_x(n,:) = nan;
            HC.AoM_Ankle_L_y(n,:) = nan;
            HC.AoM_Ankle_R_y(n,:) = nan;
            HC.AoM_Ankle_L_z(n,:) = nan;
            HC.AoM_Ankle_R_z(n,:) = nan;
            HC.AoM_Ankle_L_norm(n,:) = nan;
            HC.AoM_Ankle_R_norm(n,:) = nan;
            
            
            % General Features
            % Gyro mean
            HC.SC_Gyr_x_mean(n,:) = nan;
            HC.SC_Gyr_y_mean(n,:) = nan;
            HC.SC_Gyr_z_mean(n,:) = nan;
            HC.SC_Gyr_norm_mean(n,:) = nan;
            HC.DLS_R_Gyr_x_mean(n,:) = nan;
            HC.DLS_R_Gyr_y_mean(n,:) = nan;
            HC.DLS_R_Gyr_z_mean(n,:) = nan;
            HC.DLS_R_Gyr_norm_mean(n,:) = nan;
            HC.DLS_L_Gyr_x_mean(n,:) = nan;
            HC.DLS_L_Gyr_y_mean(n,:) = nan;
            HC.DLS_L_Gyr_z_mean(n,:) = nan;
            HC.DLS_L_Gyr_norm_mean(n,:) = nan;

            % Range
            HC.SC_Gyr_x_range(n,:) = nan;
            HC.SC_Gyr_y_range(n,:) = nan;
            HC.SC_Gyr_z_range(n,:) = nan;
            HC.SC_Gyr_norm_range(n,:) = nan;
            HC.DLS_R_Gyr_x_range(n,:) = nan;
            HC.DLS_R_Gyr_y_range(n,:) = nan;
            HC.DLS_R_Gyr_z_range(n,:) = nan;
            HC.DLS_R_Gyr_norm_range(n,:) = nan;
            HC.DLS_L_Gyr_x_range(n,:) = nan;
            HC.DLS_L_Gyr_y_range(n,:) = nan;
            HC.DLS_L_Gyr_z_range(n,:) = nan;
            HC.DLS_L_Gyr_norm_range(n,:) = nan;

            % RMS
            HC.SC_Gyr_x_rms(n,:) = nan;
            HC.SC_Gyr_y_rms(n,:) = nan;
            HC.SC_Gyr_z_rms(n,:) = nan;
            HC.SC_Gyr_norm_rms(n,:) = nan;
            HC.DLS_R_Gyr_x_rms(n,:) = nan;
            HC.DLS_R_Gyr_y_rms(n,:) = nan;
            HC.DLS_R_Gyr_z_rms(n,:) = nan;
            HC.DLS_R_Gyr_norm_rms(n,:) = nan;
            HC.DLS_L_Gyr_x_rms(n,:) = nan;
            HC.DLS_L_Gyr_y_rms(n,:) = nan;
            HC.DLS_L_Gyr_z_rms(n,:) = nan;
            HC.DLS_L_Gyr_norm_rms(n,:) = nan;

            % Standard Deviation
            HC.SC_Gyr_x_std(n,:) = nan;
            HC.SC_Gyr_y_std(n,:) = nan;
            HC.SC_Gyr_z_std(n,:) = nan;
            HC.SC_Gyr_norm_std(n,:) = nan;
            HC.DLS_R_Gyr_x_std(n,:) = nan;
            HC.DLS_R_Gyr_y_std(n,:) = nan;
            HC.DLS_R_Gyr_z_std(n,:) = nan;
            HC.DLS_R_Gyr_norm_std(n,:) = nan;
            HC.DLS_L_Gyr_x_std(n,:) = nan;
            HC.DLS_L_Gyr_y_std(n,:) = nan;
            HC.DLS_L_Gyr_z_std(n,:) = nan;
            HC.DLS_L_Gyr_norm_std(n,:) = nan;

            % Skew
            HC.SC_Gyr_x_skew(n,:) = nan;
            HC.SC_Gyr_y_skew(n,:) = nan;
            HC.SC_Gyr_z_skew(n,:) = nan;
            HC.SC_Gyr_norm_skew(n,:) = nan;
            HC.DLS_R_Gyr_x_skew(n,:) = nan;
            HC.DLS_R_Gyr_y_skew(n,:) = nan;
            HC.DLS_R_Gyr_z_skew(n,:) = nan;
            HC.DLS_R_Gyr_norm_skew(n,:) = nan;
            HC.DLS_L_Gyr_x_skew(n,:) = nan;
            HC.DLS_L_Gyr_y_skew(n,:) = nan;
            HC.DLS_L_Gyr_z_skew(n,:) = nan;
            HC.DLS_L_Gyr_norm_skew(n,:) = nan;

            % Kurtosis
            HC.SC_Gyr_x_kurtosis(n,:) = nan;
            HC.SC_Gyr_y_kurtosis(n,:) = nan;
            HC.SC_Gyr_z_kurtosis(n,:) = nan;
            HC.SC_Gyr_norm_kurtosis(n,:) = nan;
            HC.DLS_R_Gyr_x_kurtosis(n,:) = nan;
            HC.DLS_R_Gyr_y_kurtosis(n,:) = nan;
            HC.DLS_R_Gyr_z_kurtosis(n,:) = nan;
            HC.DLS_R_Gyr_norm_kurtosis(n,:) = nan;
            HC.DLS_L_Gyr_x_kurtosis(n,:) = nan;
            HC.DLS_L_Gyr_y_kurtosis(n,:) = nan;
            HC.DLS_L_Gyr_z_kurtosis(n,:) = nan;
            HC.DLS_L_Gyr_norm_kurtosis(n,:) = nan;

            % Pearson correlation coefficient
            HC.SC_Gyr_corr_xy(n,:) = nan;
            HC.SC_Gyr_corr_xz(n,:) = nan;
            HC.SC_Gyr_corr_yz(n,:) = nan;
            HC.DLS_R_Gyr_corr_xy(n,:) = nan;
            HC.DLS_R_Gyr_corr_xz(n,:) = nan;
            HC.DLS_R_Gyr_corr_yz(n,:) = nan;
            HC.DLS_L_Gyr_corr_xy(n,:) = nan;
            HC.DLS_L_Gyr_corr_xz(n,:) = nan;
            HC.DLS_L_Gyr_corr_yz(n,:) = nan;

            % Sample Entropy
            r = 0.2;
            HC.SC_Gyr_x_SamEn(n,:) = nan;
            HC.SC_Gyr_y_SamEn(n,:) = nan;
            HC.SC_Gyr_z_SamEn(n,:) = nan;
            HC.SC_Gyr_norm_SamEn(n,:) = nan;
            HC.DLS_R_Gyr_x_SamEn(n,:) = nan;
            HC.DLS_R_Gyr_y_SamEn(n,:) = nan;
            HC.DLS_R_Gyr_z_SamEn(n,:) = nan;
            HC.DLS_R_Gyr_norm_SamEn(n,:) = nan;
            HC.DLS_L_Gyr_x_SamEn(n,:) = nan;
            HC.DLS_L_Gyr_y_SamEn(n,:) = nan;
            HC.DLS_L_Gyr_z_SamEn(n,:) = nan;
            HC.DLS_L_Gyr_norm_SamEn(n,:) = nan;

            % Frequency Domain
            HC.SC_Gyr_x_DAmp(n,:) = nan;
            HC.SC_Gyr_x_DFreq(n,:) = nan;
            HC.SC_Gyr_x_PSD_mean(n,:) = nan;
            HC.SC_Gyr_x_PSD_std(n,:) = nan;
            HC.SC_Gyr_x_PSD_skew(n,:) = nan;
            HC.SC_Gyr_x_PSD_kurtosis(n,:) = nan;

            HC.SC_Gyr_y_DAmp(n,:) = nan;
            HC.SC_Gyr_y_DFreq(n,:) = nan;
            HC.SC_Gyr_y_PSD_mean(n,:) = nan;
            HC.SC_Gyr_y_PSD_std(n,:) = nan;
            HC.SC_Gyr_y_PSD_skew(n,:) = nan;
            HC.SC_Gyr_y_PSD_kurtosis(n,:) = nan;

            HC.SC_Gyr_z_DAmp(n,:) = nan;
            HC.SC_Gyr_z_DFreq(n,:) = nan;
            HC.SC_Gyr_z_PSD_mean(n,:) = nan;
            HC.SC_Gyr_z_PSD_std(n,:) = nan;
            HC.SC_Gyr_z_PSD_skew(n,:) = nan;
            HC.SC_Gyr_z_PSD_kurtosis(n,:) =nan;

            HC.SC_Gyr_norm_DAmp(n,:) = nan;
            HC.SC_Gyr_norm_DFreq(n,:) = nan;
            HC.SC_Gyr_norm_PSD_mean(n,:) = nan;
            HC.SC_Gyr_norm_PSD_std(n,:) = nan;
            HC.SC_Gyr_norm_PSD_skew(n,:) = nan;
            HC.SC_Gyr_norm_PSD_kurtosis(n,:) = nan;

            HC.DLS_R_Gyr_x_DAmp(n,:) = nan;
            HC.DLS_R_Gyr_x_DFreq(n,:) = nan;
            HC.DLS_R_Gyr_x_PSD_mean(n,:) = nan;
            HC.DLS_R_Gyr_x_PSD_std(n,:) = nan;
            HC.DLS_R_Gyr_x_PSD_skew(n,:) = nan;
            HC.DLS_R_Gyr_x_PSD_kurtosis(n,:) = nan;

            HC.DLS_R_Gyr_y_DAmp(n,:) = nan;
            HC.DLS_R_Gyr_y_DFreq(n,:) = nan;
            HC.DLS_R_Gyr_y_PSD_mean(n,:) = nan;
            HC.DLS_R_Gyr_y_PSD_std(n,:) = nan;
            HC.DLS_R_Gyr_y_PSD_skew(n,:) = nan;
            HC.DLS_R_Gyr_y_PSD_kurtosis(n,:) = nan;

            HC.DLS_R_Gyr_z_DAmp(n,:) = nan;
            HC.DLS_R_Gyr_z_DFreq(n,:) = nan;
            HC.DLS_R_Gyr_z_PSD_mean(n,:) = nan;
            HC.DLS_R_Gyr_z_PSD_std(n,:) = nan;
            HC.DLS_R_Gyr_z_PSD_skew(n,:) = nan;
            HC.DLS_R_Gyr_z_PSD_kurtosis(n,:) = nan;

            HC.DLS_R_Gyr_norm_DAmp(n,:) = nan;
            HC.DLS_R_Gyr_norm_DFreq(n,:) = nan;
            HC.DLS_R_Gyr_norm_PSD_mean(n,:) = nan;
            HC.DLS_R_Gyr_norm_PSD_std(n,:) = nan;
            HC.DLS_R_Gyr_norm_PSD_skew(n,:) = nan;
            HC.DLS_R_Gyr_norm_PSD_kurtosis(n,:) = nan;

            HC.DLS_L_Gyr_x_DAmp(n,:) = nan;
            HC.DLS_L_Gyr_x_DFreq(n,:) = nan;
            HC.DLS_L_Gyr_x_PSD_mean(n,:) = nan;
            HC.DLS_L_Gyr_x_PSD_std(n,:) = nan;
            HC.DLS_L_Gyr_x_PSD_skew(n,:) = nan;
            HC.DLS_L_Gyr_x_PSD_kurtosis(n,:) = nan;

            HC.DLS_L_Gyr_y_DAmp(n,:) = nan;
            HC.DLS_L_Gyr_y_DFreq(n,:) = nan;
            HC.DLS_L_Gyr_y_PSD_mean(n,:) = nan;
            HC.DLS_L_Gyr_y_PSD_std(n,:) = nan;
            HC.DLS_L_Gyr_y_PSD_skew(n,:) = nan;
            HC.DLS_L_Gyr_y_PSD_kurtosis(n,:) = nan;

            HC.DLS_L_Gyr_z_DAmp(n,:) = nan;
            HC.DLS_L_Gyr_z_DFreq(n,:) = nan;
            HC.DLS_L_Gyr_z_PSD_mean(n,:) = nan;
            HC.DLS_L_Gyr_z_PSD_std(n,:) = nan;
            HC.DLS_L_Gyr_z_PSD_skew(n,:) = nan;
            HC.DLS_L_Gyr_z_PSD_kurtosis(n,:) = nan;

            HC.DLS_L_Gyr_norm_DAmp(n,:) = nan;
            HC.DLS_L_Gyr_norm_DFreq(n,:) = nan;
            HC.DLS_L_Gyr_norm_PSD_mean(n,:) = nan;
            HC.DLS_L_Gyr_norm_PSD_std(n,:) = nan;
            HC.DLS_L_Gyr_norm_PSD_skew(n,:) = nan;
            HC.DLS_L_Gyr_norm_PSD_kurtosis(n,:) = nan;


            % Acc mean
            HC.SC_Acc_x_mean(n,:) = nan;
            HC.SC_Acc_y_mean(n,:) = nan;
            HC.SC_Acc_z_mean(n,:) = nan;
            HC.SC_Acc_norm_mean(n,:) = nan;
            HC.DLS_R_Acc_x_mean(n,:) = nan;
            HC.DLS_R_Acc_y_mean(n,:) = nan;
            HC.DLS_R_Acc_z_mean(n,:) = nan;
            HC.DLS_R_Acc_norm_mean(n,:) = nan;
            HC.DLS_L_Acc_x_mean(n,:) = nan;
            HC.DLS_L_Acc_y_mean(n,:) = nan;
            HC.DLS_L_Acc_z_mean(n,:) = nan;
            HC.DLS_L_Acc_norm_mean(n,:) = nan;

            % Range
            HC.SC_Acc_x_range(n,:) = nan;
            HC.SC_Acc_y_range(n,:) = nan;
            HC.SC_Acc_z_range(n,:) = nan;
            HC.SC_Acc_norm_range(n,:) = nan;
            HC.DLS_R_Acc_x_range(n,:) = nan;
            HC.DLS_R_Acc_y_range(n,:) = nan;
            HC.DLS_R_Acc_z_range(n,:) = nan;
            HC.DLS_R_Acc_norm_range(n,:) = nan;
            HC.DLS_L_Acc_x_range(n,:) = nan;
            HC.DLS_L_Acc_y_range(n,:) = nan;
            HC.DLS_L_Acc_z_range(n,:) = nan;
            HC.DLS_L_Acc_norm_range(n,:) = nan;

            % RMS
            HC.SC_Acc_x_rms(n,:) = nan;
            HC.SC_Acc_y_rms(n,:) = nan;
            HC.SC_Acc_z_rms(n,:) = nan;
            HC.SC_Acc_norm_rms(n,:) = nan;
            HC.DLS_R_Acc_x_rms(n,:) = nan;
            HC.DLS_R_Acc_y_rms(n,:) = nan;
            HC.DLS_R_Acc_z_rms(n,:) = nan;
            HC.DLS_R_Acc_norm_rms(n,:) = nan;
            HC.DLS_L_Acc_x_rms(n,:) = nan;
            HC.DLS_L_Acc_y_rms(n,:) = nan;
            HC.DLS_L_Acc_z_rms(n,:) = nan;
            HC.DLS_L_Acc_norm_rms(n,:) = nan;

            % Standard Deviation
            HC.SC_Acc_x_std(n,:) = nan;
            HC.SC_Acc_y_std(n,:) = nan;
            HC.SC_Acc_z_std(n,:) = nan;
            HC.SC_Acc_norm_std(n,:) = nan;
            HC.DLS_R_Acc_x_std(n,:) = nan;
            HC.DLS_R_Acc_y_std(n,:) = nan;
            HC.DLS_R_Acc_z_std(n,:) = nan;
            HC.DLS_R_Acc_norm_std(n,:) = nan;
            HC.DLS_L_Acc_x_std(n,:) = nan;
            HC.DLS_L_Acc_y_std(n,:) = nan;
            HC.DLS_L_Acc_z_std(n,:) = nan;
            HC.DLS_L_Acc_norm_std(n,:) = nan;

            % Skew
            HC.SC_Acc_x_skew(n,:) = nan;
            HC.SC_Acc_y_skew(n,:) = nan;
            HC.SC_Acc_z_skew(n,:) = nan;
            HC.SC_Acc_norm_skew(n,:) = nan;
            HC.DLS_R_Acc_x_skew(n,:) = nan;
            HC.DLS_R_Acc_y_skew(n,:) = nan;
            HC.DLS_R_Acc_z_skew(n,:) = nan;
            HC.DLS_R_Acc_norm_skew(n,:) = nan;
            HC.DLS_L_Acc_x_skew(n,:) = nan;
            HC.DLS_L_Acc_y_skew(n,:) = nan;
            HC.DLS_L_Acc_z_skew(n,:) = nan;
            HC.DLS_L_Acc_norm_skew(n,:) = nan;

            % Kurtosis
            HC.SC_Acc_x_kurtosis(n,:) = nan;
            HC.SC_Acc_y_kurtosis(n,:) = nan;
            HC.SC_Acc_z_kurtosis(n,:) = nan;
            HC.SC_Acc_norm_kurtosis(n,:) = nan;
            HC.DLS_R_Acc_x_kurtosis(n,:) = nan;
            HC.DLS_R_Acc_y_kurtosis(n,:) = nan;
            HC.DLS_R_Acc_z_kurtosis(n,:) = nan;
            HC.DLS_R_Acc_norm_kurtosis(n,:) = nan;
            HC.DLS_L_Acc_x_kurtosis(n,:) = nan;
            HC.DLS_L_Acc_y_kurtosis(n,:) = nan;
            HC.DLS_L_Acc_z_kurtosis(n,:) = nan;
            HC.DLS_L_Acc_norm_kurtosis(n,:) = nan;

            % Pearson correlation coefficient
            HC.SC_Acc_corr_xy(n,:) = nan;
            HC.SC_Acc_corr_xz(n,:) = nan;
            HC.SC_Acc_corr_yz(n,:) = nan;
            HC.DLS_R_Acc_corr_xy(n,:) = nan;
            HC.DLS_R_Acc_corr_xz(n,:) = nan;
            HC.DLS_R_Acc_corr_yz(n,:) = nan;
            HC.DLS_L_Acc_corr_xy(n,:) = nan;
            HC.DLS_L_Acc_corr_xz(n,:) = nan;
            HC.DLS_L_Acc_corr_yz(n,:) = nan;

            % Sample Entropy
            r = 0.2;
            HC.SC_Acc_x_SamEn(n,:) = nan;
            HC.SC_Acc_y_SamEn(n,:) = nan;
            HC.SC_Acc_z_SamEn(n,:) = nan;
            HC.SC_Acc_norm_SamEn(n,:) = nan;
            HC.DLS_R_Acc_x_SamEn(n,:) = nan;
            HC.DLS_R_Acc_y_SamEn(n,:) = nan;
            HC.DLS_R_Acc_z_SamEn(n,:) = nan;
            HC.DLS_R_Acc_norm_SamEn(n,:) = nan;
            HC.DLS_L_Acc_x_SamEn(n,:) = nan;
            HC.DLS_L_Acc_y_SamEn(n,:) = nan;
            HC.DLS_L_Acc_z_SamEn(n,:) = nan;
            HC.DLS_L_Acc_norm_SamEn(n,:) = nan;


            % Frequency Domain
            HC.SC_Acc_x_DAmp(n,:) = nan;
            HC.SC_Acc_x_DFreq(n,:) = nan;
            HC.SC_Acc_x_PSD_mean(n,:) = nan;
            HC.SC_Acc_x_PSD_std(n,:) = nan;
            HC.SC_Acc_x_PSD_skew(n,:) = nan;
            HC.SC_Acc_x_PSD_kurtosis(n,:) = nan;

            HC.SC_Acc_y_DAmp(n,:) = nan;
            HC.SC_Acc_y_DFreq(n,:) = nan;
            HC.SC_Acc_y_PSD_mean(n,:) = nan;
            HC.SC_Acc_y_PSD_std(n,:) = nan;
            HC.SC_Acc_y_PSD_skew(n,:) = nan;
            HC.SC_Acc_y_PSD_kurtosis(n,:) = nan;

            HC.SC_Acc_z_DAmp(n,:) = nan;
            HC.SC_Acc_z_DFreq(n,:) = nan;
            HC.SC_Acc_z_PSD_mean(n,:) = nan;
            HC.SC_Acc_z_PSD_std(n,:) = nan;
            HC.SC_Acc_z_PSD_skew(n,:) = nan;
            HC.SC_Acc_z_PSD_kurtosis(n,:) = nan;

            HC.SC_Acc_norm_DAmp(n,:) = nan;
            HC.SC_Acc_norm_DFreq(n,:) = nan;
            HC.SC_Acc_norm_PSD_mean(n,:) = nan;
            HC.SC_Acc_norm_PSD_std(n,:) = nan;
            HC.SC_Acc_norm_PSD_skew(n,:) = nan;
            HC.SC_Acc_norm_PSD_kurtosis(n,:) = nan;

            HC.DLS_R_Acc_x_DAmp(n,:) = nan;
            HC.DLS_R_Acc_x_DFreq(n,:) = nan;
            HC.DLS_R_Acc_x_PSD_mean(n,:) = nan;
            HC.DLS_R_Acc_x_PSD_std(n,:) = nan;
            HC.DLS_R_Acc_x_PSD_skew(n,:) = nan;
            HC.DLS_R_Acc_x_PSD_kurtosis(n,:) = nan;

            HC.DLS_R_Acc_y_DAmp(n,:) = nan;
            HC.DLS_R_Acc_y_DFreq(n,:) = nan;
            HC.DLS_R_Acc_y_PSD_mean(n,:) = nan;
            HC.DLS_R_Acc_y_PSD_std(n,:) = nan;
            HC.DLS_R_Acc_y_PSD_skew(n,:) = nan;
            HC.DLS_R_Acc_y_PSD_kurtosis(n,:) = nan;

            HC.DLS_R_Acc_z_DAmp(n,:) = nan;
            HC.DLS_R_Acc_z_DFreq(n,:) = nan;
            HC.DLS_R_Acc_z_PSD_mean(n,:) = nan;
            HC.DLS_R_Acc_z_PSD_std(n,:) = nan;
            HC.DLS_R_Acc_z_PSD_skew(n,:) = nan;
            HC.DLS_R_Acc_z_PSD_kurtosis(n,:) = nan;

            HC.DLS_R_Acc_norm_DAmp(n,:) = nan;
            HC.DLS_R_Acc_norm_DFreq(n,:) = nan;
            HC.DLS_R_Acc_norm_PSD_mean(n,:) = nan;
            HC.DLS_R_Acc_norm_PSD_std(n,:) = nan;
            HC.DLS_R_Acc_norm_PSD_skew(n,:) = nan;
            HC.DLS_R_Acc_norm_PSD_kurtosis(n,:) = nan;

            HC.DLS_L_Acc_x_DAmp(n,:) = nan;
            HC.DLS_L_Acc_x_DFreq(n,:) = nan;
            HC.DLS_L_Acc_x_PSD_mean(n,:) = nan;
            HC.DLS_L_Acc_x_PSD_std(n,:) = nan;
            HC.DLS_L_Acc_x_PSD_skew(n,:) = nan;
            HC.DLS_L_Acc_x_PSD_kurtosis(n,:) = nan;

            HC.DLS_L_Acc_y_DAmp(n,:) = nan;
            HC.DLS_L_Acc_y_DFreq(n,:) = nan;
            HC.DLS_L_Acc_y_PSD_mean(n,:) = nan;
            HC.DLS_L_Acc_y_PSD_std(n,:) = nan;
            HC.DLS_L_Acc_y_PSD_skew(n,:) = nan;
            HC.DLS_L_Acc_y_PSD_kurtosis(n,:) = nan;

            HC.DLS_L_Acc_z_DAmp(n,:) = nan;
            HC.DLS_L_Acc_z_DFreq(n,:) = nan;
            HC.DLS_L_Acc_z_PSD_mean(n,:) = nan;
            HC.DLS_L_Acc_z_PSD_std(n,:) = nan;
            HC.DLS_L_Acc_z_PSD_skew(n,:) = nan;
            HC.DLS_L_Acc_z_PSD_kurtosis(n,:) = nan;

            HC.DLS_L_Acc_norm_DAmp(n,:) = nan;
            HC.DLS_L_Acc_norm_DFreq(n,:) = nan;
            HC.DLS_L_Acc_norm_PSD_mean(n,:) = nan;
            HC.DLS_L_Acc_norm_PSD_std(n,:) = nan;
            HC.DLS_L_Acc_norm_PSD_skew(n,:) = nan;
            HC.DLS_L_Acc_norm_PSD_kurtosis(n,:) = nan;
            
        elseif ismember(n,ID_HC) == 1
...
%     end
    ...
    Sub_ID_ = Sub_ID_';
    Sub_Type_ = Sub_Type_';
    Cut_Off_Time_ = TS(k)*ones(length(ID),1);
...
writetable(tbl_Features,'Feature_Matrix_Automation_6MWT_test.csv','Delimiter',',','QuoteStrings',true)
