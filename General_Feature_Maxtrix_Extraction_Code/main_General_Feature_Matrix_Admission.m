...
k=1;
for n = 1:1:length(ID)
    file_input = ['\\fs2.smpp.local\RTO\Inpatient Sensors -Stroke\MC10 Study\Data analysis\2_Clean_Data_Extracted\6MWT\' Type_of_Subject '_MWT6_ID' sprintf('%.2d',ID(n)) '.mat']
    load(file_input);
