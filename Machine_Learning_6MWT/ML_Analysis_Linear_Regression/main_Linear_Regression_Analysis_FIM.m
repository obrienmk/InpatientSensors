...
AoM = import_data('./FIM_AoM_only.csv')
Gyr = import_data('./FIM_Gyro_only.csv')
Acc = import_data('./FIM_Acc_only.csv')
AoM_Gyr = import_data('./FIM_AoM_Gyro.csv')
AoM_Acc = import_data('./FIM_AoM_Acc.csv')
Gyr_Acc = import_data('./FIM_Gyro_Acc.csv')
AoM_Gyr_Acc = import_data('./FIM_AoM_Gyro_Acc.csv')
