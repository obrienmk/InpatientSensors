...
AoM = import_data('./BBS_AoM_only.csv')
Gyr = import_data('./BBS_Gyro_only.csv')
Acc = import_data('./BBS_Acc_only.csv')
AoM_Gyr = import_data('./BBS_AoM_Gyro.csv')
AoM_Acc = import_data('./BBS_AoM_Acc.csv')
Gyr_Acc = import_data('./BBS_Gyro_Acc.csv')
AoM_Gyr_Acc = import_data('./BBS_AoM_Gyro_Acc.csv')
