...
% CVA
% ID: 1, 3, 7, 9, 17, 19, 22, 25, 30, 32, 33, 42, 44, 49  --> no data
% ID: 40 --> sensor at DLS_L missing
...
for n = 1:1:length(ID)
    ...
    if n == 1 || n == 3 || n == 7 || n == 8 || n == 9 || n == 17 || n == 19 || n == 22 || n == 25 || n == 30 || n == 32 || n == 33 || n == 40 || n == 42 || n == 44 || n == 49
         SN = nan;     % Session #
         TN = nan;     % Trial #
