function main_DataStruct(Subject_type,Activity,Subj2Load)
    % *************************************************************************
    % main_Data_Extract.m
    %
...
%   % Subj2Load: Subject numbers to load (1:55)
    ...
    Activity = 'MWT6';  % Select one from list of nicknames below
    Subj2Load = [1:10];   % Subject numbers to load (1:55)
